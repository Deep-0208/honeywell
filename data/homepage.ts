...
export const clientLogos: ClientLogo[] = [
  { name: 'Prikan Machinery Pvt Ltd', imageSrc: '/images/shared/clients/prikan-machinery-pvt-ltd.webp' },
  { name: 'Aqseptence Group of India Pvt Ltd', imageSrc: '/images/shared/clients/aqseptence-group-of-india-pvt-ltd.webp' },
  { name: 'ITL Industries', imageSrc: '/images/shared/clients/itl-industries.webp' },
  { name: 'Indotech Industries', imageSrc: '/images/shared/clients/indotech-industries.webp' },
  { name: 'Naturage Storage Solution Pvt Ltd', imageSrc: '/images/shared/clients/naturage-storage-solution-pvt-ltd.webp' },
  { name: 'Dhanwanti Engineering', imageSrc: '/images/shared/clients/dhanwanti-engineering.webp' },
  { name: 'Jai Industries', imageSrc: '/images/shared/clients/jai-industries.webp' },
  { name: 'Sharda Industries', imageSrc: '/images/shared/clients/sharda-industries.webp' },
  { name: 'J.J. Industries', imageSrc: '/images/shared/clients/j-j-industries.webp' },
  { name: 'Spincast Solution Pvt ltd', imageSrc: '/images/shared/clients/spincast-solution-pvt-ltd.webp' },
  { name: 'Asian Tubes Pvt Ltd', imageSrc: '/images/shared/clients/asian-tubes-pvt-ltd.webp' },
  { name: 'Ratnamani Metal & Tubes', imageSrc: '/images/shared/clients/ratnamani-metal-tubes.webp' },
  { name: 'Hardik Engineering', imageSrc: '/images/shared/clients/hardik-engineering.webp' },
  { name: 'Safari Construction Equipments Pvt Ltd', imageSrc: '/images/shared/clients/safari-construction-equipments-pvt-ltd.webp' },
  { name: 'Neelam Fabricators', imageSrc: '/images/shared/clients/neelam-fabricators.webp' },
  { name: 'Optiflux Pipe Industries', imageSrc: '/images/shared/clients/optiflux-pipe-industries.webp' },
  { name: 'Rama Cylinders Pvt Ltd', imageSrc: '/images/shared/clients/rama-cylinders-pvt-ltd.webp' },
  { name: 'Modi Enterprise', imageSrc: '/images/shared/clients/modi-enterprise.webp' },
  { name: 'Sushobhit Moulds', imageSrc: '/images/shared/clients/sushobhit-moulds.webp' },
  { name: 'Creative Automation', imageSrc: '/images/shared/clients/creative-automation.webp' },
];
