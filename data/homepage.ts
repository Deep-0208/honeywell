...
export const homepageProducts: HomepageProduct[] = [
  {
    ...
    imageSrc: '/images/products/hydraulic-cylinders-ahmedabad.webp',
...
export const clientLogos: ClientLogo[] = [
  { name: 'Prikan Machinery Pvt Ltd', imageSrc: '/images/clients/client-01.png' },
  { name: 'Aqseptence Group of India Pvt Ltd', imageSrc: '/images/clients/client-02.png' },
  { name: 'ITL Industries', imageSrc: '/images/clients/client-03.png' },
  { name: 'Indotech Industries', imageSrc: '/images/clients/client-04.png' },
  { name: 'Naturage Storage Solution Pvt Ltd', imageSrc: '/images/clients/client-05.png' },
  { name: 'Dhanwanti Engineering', imageSrc: '/images/clients/client-06.png' },
  { name: 'Jai Industries', imageSrc: '/images/clients/client-07.png' },
  { name: 'Sharda Industries', imageSrc: '/images/clients/client-08.png' },
  { name: 'J.J. Industries', imageSrc: '/images/clients/client-09.png' },
  { name: 'Spincast Solution Pvt ltd', imageSrc: '/images/clients/client-010.png' },
  { name: 'Asian Tubes Pvt Ltd', imageSrc: '/images/clients/client-011.png' },
  { name: 'Ratnamani Metal & Tubes', imageSrc: '/images/clients/client-012.png' },
  { name: 'Hardik Engineering', imageSrc: '/images/clients/client-013.png' },
  { name: 'Safari Construction Equipments Pvt Ltd', imageSrc: '/images/clients/client-014.png' },
  { name: 'Neelam Fabricators', imageSrc: '/images/clients/client-015.png' },
  { name: 'Optiflux Pipe Industries', imageSrc: '/images/clients/client-016.png' },
  { name: 'Rama Cylinders Pvt Ltd', imageSrc: '/images/clients/client-017.png' },
  { name: 'Modi Enterprise', imageSrc: '/images/clients/client-018.png' },
  { name: 'Sushobhit Moulds', imageSrc: '/images/clients/client-019.png' },
  { name: 'Creative Automation', imageSrc: '/images/clients/client-020.png' },
];
