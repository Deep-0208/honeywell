...
export function IndustryCard({
  ...
  return (
    <Card variant="interactive" className="flex flex-col h-full group relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-[#0D1B5C]/[0.02] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" aria-hidden="true" />
      ...
      <CardContent className="flex flex-col flex-1 p-8 relative">
        ...
        <h3 className="text-xl font-display font-bold text-[#0D1B5C] mb-3 group-hover:text-[#E31B23] transition-colors duration-200">
        ...
        <p className="text-[#64748B] font-body text-sm mb-8 line-clamp-3 flex-1">
          {description}
        </p>

        <div className="mt-auto flex items-center text-[#E31B23] font-medium font-body text-sm">
          {ctaText}
