              ...
              <div className="flex items-center gap-6">
                ...
                <div className="flex items-center gap-3" aria-label="Social media links">
                  ...
                  <a
                    ...
                    className="w-7 h-7 rounded-full flex items-center justify-center text-[#94A3B8] hover:text-white hover:bg-white/10 transition-all duration-200 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-white hover:scale-110"
                  >
