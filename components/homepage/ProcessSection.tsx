        ...
        <div className="relative">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, i) => (
              ...
              >
                {/* Step number */}
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-full bg-honeywell-navy text-white font-mono font-bold text-base sm:text-lg flex items-center justify-center mb-4 relative z-10 ring-4 ring-brand-surfaceGray">
