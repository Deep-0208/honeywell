...
import { ArrowRight, CheckCircle2, Globe, Cog } from "lucide-react";
...
/** * HeroSection * * Homepage hero — the primary LCP element and first conversion point. * White background with two-column layout on desktop. * * @see HOMEPAGE_ARCHITECTURE.md § Section 01 */ export function HeroSection() {
  return (
    <section
    ...
    >
      ...
      >
        {" "}
        <div className="absolute inset-0 bg-[url('/images/shared/industrial-texture-background.webp')] opacity-[0.03] mix-blend-overlay" />{" "}
      ...
      <Container className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center pt-6 pb-8 sm:pt-8 sm:pb-12 md:pt-12 md:pb-16 lg:pt-16 lg:pb-20">
          ...
          <div className="order-1">
            ...
            <p className="text-base sm:text-lg md:text-xl font-body text-honeywell-red mb-3 sm:mb-4 ">
              {" "}
            ...
            <div>
              ...
              >
                {" "}
                Hydraulic Cylinder & Hydraulic Powerpack Manufacturer in India
                Since 2018{" "}
              </Heading>{" "}
            </div>{" "}
            ...
            <div className="flex flex-col gap-5 sm:gap-7 mb-8 sm:mb-10 max-w-2xl">
              ...
              <div className="flex items-center gap-3 sm:gap-5">
                ...
                <span className="flex shrink-0 items-center justify-center w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 rounded-full bg-honeywell-navy/5 border border-honeywell-navy/10">
                  {" "}
                  <Globe
                    className="w-5 h-5 sm:w-6 sm:h-6 md:w-7 md:h-7 text-honeywell-navy"
                    strokeWidth={2}
                  />{" "}
                </span>{" "}
