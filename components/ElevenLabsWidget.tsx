      ...
      <div className="flex flex-col items-center justify-center py-4 min-h-[200px]">
        {isConnecting && (
          <div className="flex flex-col items-center gap-5 text-honeywell-navy">
            ...
            <p className="text-sm font-medium text-gray-500 tracking-wide uppercase text-[11px] letter-spacing-widest text-justify">
              Connecting securely...
            </p>
          </div>
        )}
    ...
    <div className="fixed bottom-20 right-4 sm:bottom-24 sm:right-6 lg:bottom-8 lg:right-8 z-[9999] flex flex-col items-end gap-4 font-sans">
      {isOpen && (
        <ConversationProvider>
          <ConversationModal onClose={() => setIsOpen(false)} />
        </ConversationProvider>
      )}
