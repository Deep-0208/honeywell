  ...
  return (
    <div className="bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
      <h3>
        ...
        >
          <span className={`text-lg font-bold font-display pr-6 transition-colors duration-200 text-justify ${isOpen ? 'text-honeywell-red' : 'text-honeywell-navy group-hover:text-honeywell-red'}`}>
            {question}
          </span>
        ...
        >
          <div className="overflow-hidden">
            <div className="text-base text-brand-steelGray font-body px-6 pr-12 whitespace-pre-wrap pb-6 leading-relaxed text-justify">
              {answer}
            </div>
          </div>
        </div>
