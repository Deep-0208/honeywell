    ...
    <div className="bg-white">
      <h3>
        <button
          ...
          onClick={onToggle}
          className="flex w-full items-center justify-between py-6 text-left focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-honeywell-navy focus-visible:rounded-sm group"
        >
        ...
        >
          <div className="overflow-hidden">
            <div className="text-base text-brand-steelGray font-body pr-12 whitespace-pre-wrap pb-6 leading-relaxed">
              {answer}
            </div>
          </div>
        </div>
