...
import { PILLAR_INDUSTRIES } from '@/data/hydraulic-cylinders/pillar';
    ...
    <Section bg="white" id="industries" aria-labelledby="industries-heading">
      <Container>
        <div className="text-center max-w-3xl mx-auto mb-12 flex flex-col items-center">
          ...
          <Link href="/request-quote/#quote-form" className="text-honeywell-red font-bold hover:underline">
