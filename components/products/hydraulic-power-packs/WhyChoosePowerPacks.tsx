      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            <IconBox icon={<PenTool className="w-6 h-6 text-white" />} variant="primary" size="lg" className="mb-6" />
          ...
          <div className="flex flex-col">
            <IconBox icon={<Settings className="w-6 h-6 text-white" />} variant="primary" size="lg" className="mb-6" />
