...
const INFRA_FAQS = [
  ...
  },
  {
    ...
    answer:
      'Yes. We welcome client visits for facility audits, first-article inspections, and witnessed factory acceptance tests. Our team will walk you through every stage of the manufacturing process. Contact engineering@honeywellhydraulics.com to schedule a visit.',
  },
];
        ...
        <Container>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={item.label} className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-sm p-5 text-center">
        ...
        <Container>
          ...
          <ul className="grid grid-cols-1 sm:grid-cols-2 gap-8" role="list">
            {MACHINING_EQUIPMENT.map((eq) => (
              <li key={eq.name} className="bg-white border border-[#E2E8F0] rounded-sm p-6 hover:border-[#E31B23] transition-colors">
                <div className="w-12 h-12 rounded-full bg-[#0D1B5C] flex items-center justify-center text-white mb-4">
                  {eq.icon}
                </div>
                <h3 className="text-lg font-display font-bold text-[#0D1B5C] mb-2">{eq.name}</h3>
                <p className="text-sm text-[#64748B] font-body leading-relaxed">{eq.desc}</p>
              </li>
            ))}
          </ul>
        </Container>
            ...
            <div className="bg-[#F8FAFC] border border-[#E2E8F0] rounded-sm p-8">
              <div className="aspect-[4/3] bg-[#E2E8F0] rounded-sm flex items-center justify-center">
                <div className="text-center px-6">
                  ...
                  <p className="text-sm font-semibold text-[#334155] font-body">Assembly Bay</p>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {TESTING_EQUIPMENT.map((eq) => (
              <div key={eq.name} className="bg-white border border-[#E2E8F0] rounded-sm p-6 hover:border-[#E31B23] transition-colors">
                <Microscope className="w-8 h-8 text-[#0D1B5C] mb-4" aria-hidden="true" />
                <h3 className="text-lg font-display font-bold text-[#0D1B5C] mb-2">{eq.name}</h3>
                <p className="text-sm text-[#64748B] font-body leading-relaxed">{eq.desc}</p>
              </div>
            ))}
          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
              {[
                ...
                <div key={item.title} className="bg-white border border-[#E2E8F0] rounded-sm p-5 text-center">
                  <IconBox icon={item.icon} variant="primary" className="mx-auto mb-3" />
                  <h3 className="text-sm font-display font-bold text-[#0D1B5C] mb-2">{item.title}</h3>
                  <p className="text-xs text-[#64748B] font-body">{item.desc}</p>
                </div>
              ))}
            </div>
          </div>
