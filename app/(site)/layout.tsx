    ...
    <>
      ...
      <a
        ...
        className="
          ...
          focus:bg-honeywell-navy focus:text-white focus:font-medium
          focus:rounded-sm focus:outline-none focus:ring-2 focus:ring-honeywell-red focus:ring-offset-2
          font-body text-sm
        "
      >
