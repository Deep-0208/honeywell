      ...
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative w-full aspect-[4/3] lg:aspect-square bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden group">
            ...
            <Image src="/images/products/double-acting-hydraulic-cylinder.webp" alt="Double acting hydraulic cylinder manufacturer in Ahmedabad — Honeywell Hydraulics" fill priority className="object-cover p-8 group-hover:scale-105 transition-transform duration-700 ease-out" sizes="(max-width: 1024px) 100vw, 50vw" />
        </div>
        </div>
      </Container>
