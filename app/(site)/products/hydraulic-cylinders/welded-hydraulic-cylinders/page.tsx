      ...
      <Container>
        ...
        <nav aria-label="Breadcrumb" className="mb-8">
          <ol className="flex flex-wrap items-center text-sm text-[#64748B] font-body gap-1.5">
            ...
            <li aria-hidden="true">/</li>
            <li>
              <Link href="/products/hydraulic-cylinders/" className="hover:text-[#E31B23] transition-colors">
                Hydraulic Cylinders
              </Link>
            </li>
            <li aria-hidden="true">/</li>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-5 text-[#334155] font-body text-lg leading-relaxed">
            <p>
              ...
              <strong className="text-[#0D1B5C]">Welded Hydraulic Cylinders</strong>.
            </p>
            <p>
              Unlike{' '}
              <Link
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {advantages.map((adv, idx) => (
            <div
              key={idx}
              className="bg-[#F8FAFC] rounded-xl border border-[#E2E8F0] p-8 hover:shadow-md transition-shadow duration-300 flex flex-col"
            >
              <div className="mb-6">
              ...
              <p className="text-[#64748B] font-body text-sm leading-relaxed flex-grow">
                {adv.description}
              </p>
            </div>
          ))}
          ...
          <table className="w-full text-left border-collapse min-w-[800px]">
            ...
            <tbody className="divide-y divide-[#E2E8F0]">
              <tr className="hover:bg-[#F8FAFC]/50">
                <td className="px-6 py-4 font-semibold text-[#334155]">Construction Method</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">End caps and mounts permanently welded to barrel</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">External threaded rods clamp square caps to barrel</td>
              </tr>
              <tr className="hover:bg-[#F8FAFC]/50 bg-[#F8FAFC]/30">
                <td className="px-6 py-4 font-semibold text-[#334155]">Maximum Pressure</td>
                <td className="px-6 py-4 text-[#E31B23] font-bold border-l border-[#E2E8F0]">Extreme (Up to 350+ Bar / 5000+ PSI)</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Low to Medium (Up to 210 Bar / 3000 PSI)</td>
              </tr>
              <tr className="hover:bg-[#F8FAFC]/50">
                <td className="px-6 py-4 font-semibold text-[#334155]">Shock Load Resistance</td>
                <td className="px-6 py-4 text-[#0D1B5C] font-semibold border-l border-[#E2E8F0]">Excellent. Fused structure absorbs heavy vibration</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Poor. Shock loads can stretch tie rods, causing leaks</td>
              </tr>
              <tr className="hover:bg-[#F8FAFC]/50 bg-[#F8FAFC]/30">
                <td className="px-6 py-4 font-semibold text-[#334155]">Physical Profile</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Sleek, highly compact footprint</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Bulky due to external rods and square caps</td>
              </tr>
              <tr className="hover:bg-[#F8FAFC]/50">
                <td className="px-6 py-4 font-semibold text-[#334155]">Environmental Threat</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Survives mud, dust, weather, and marine salt</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Vulnerable to dirt buildup on external threads</td>
              </tr>
              <tr className="hover:bg-[#F8FAFC]/50 bg-[#F8FAFC]/30">
                <td className="px-6 py-4 font-semibold text-[#334155]">Serviceability</td>
                <td className="px-6 py-4 text-[#334155] border-l border-[#E2E8F0]">Low. Requires specialized tools or machining to rebuild</td>
                <td className="px-6 py-4 text-[#0D1B5C] font-semibold border-l border-[#E2E8F0]">High. Can be disassembled with standard wrenches</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {industries.map((ind, idx) => (
            <div
              key={idx}
              className="bg-white rounded-xl border border-[#E2E8F0] p-6 flex items-start gap-4 hover:shadow-md transition-shadow duration-300"
            >
              <div className="mt-1">
      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-[#334155] font-body text-lg mb-8">
            Our{' '}
            <Link href="/services/custom-hydraulic-system-design/" className="text-[#E31B23] font-semibold hover:underline">
          ...
          <div className="space-y-8">
            <div className="bg-[#F8FAFC] p-8 rounded-xl border border-[#E2E8F0]">
              <h3 className="text-xl font-bold text-[#0D1B5C] mb-3 flex items-center gap-3">
                <span className="bg-[#0D1B5C] text-white w-8 h-8 rounded flex items-center justify-center text-sm font-bold">A</span>
                Pressure Ratings & Wall Thickness
              </h3>
              <p className="text-[#334155] text-sm leading-relaxed pl-11">
            ...
            <div className="bg-[#F8FAFC] p-8 rounded-xl border border-[#E2E8F0]">
              <h3 className="text-xl font-bold text-[#0D1B5C] mb-3 flex items-center gap-3">
                <span className="bg-[#0D1B5C] text-white w-8 h-8 rounded flex items-center justify-center text-sm font-bold">B</span>
            ...
            <div className="bg-[#F8FAFC] p-8 rounded-xl border border-[#E2E8F0]">
              <h3 className="text-xl font-bold text-[#0D1B5C] mb-3 flex items-center gap-3">
                <span className="bg-[#0D1B5C] text-white w-8 h-8 rounded flex items-center justify-center text-sm font-bold">C</span>
    ...
    <Section bg="gray" id="manufacturing">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#0D1B5C]">Advanced Welding</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#0D1B5C]">Post-Weld Machining</h4>
                  <p className="text-[#64748B] text-sm mt-1 leading-relaxed">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="text-lg font-bold text-[#0D1B5C]">Shock-Load Validation</h4>
                  <p className="text-[#64748B] text-sm mt-1 leading-relaxed">
            ...
            <div className="bg-white p-6 rounded-xl border border-[#E2E8F0] mb-6">
              <h4 className="font-bold text-[#0D1B5C] flex items-center gap-2 mb-2">
                <FileCheck className="w-5 h-5 text-[#E31B23]" />
            ...
            <div className="bg-[#0D1B5C] p-6 rounded-xl border border-[#E2E8F0]">
          ...
          <div className="relative w-full aspect-[4/3] rounded-xl overflow-hidden shadow-lg border border-[#E2E8F0]">
            <Image
              src="/images/products/welded-hydraulic-cylinder-manufacturer.webp"
        ...
        <div className="bg-[#F8FAFC] rounded-2xl border border-[#E2E8F0] overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2">
            <div className="p-8 lg:p-12 flex flex-col justify-center">
              ...
              <h2 className="text-2xl md:text-3xl font-display font-bold text-[#0D1B5C] mb-6">
                Heavy-Duty Welded Cylinder Retrofit for a Steel Forging Press
              </h2>
              
              <div className="space-y-6">
                <div>
                  <h4 className="font-bold text-[#0D1B5C] uppercase text-xs tracking-wider mb-2">The Challenge:</h4>
                ...
                <div>
                  <h4 className="font-bold text-[#0D1B5C] uppercase text-xs tracking-wider mb-2">The Solution:</h4>
                  <p className="text-[#334155] text-sm leading-relaxed">
                ...
                <div className="bg-white p-5 rounded-xl border border-[#E2E8F0] shadow-sm">
                  <h4 className="font-bold text-[#E31B23] uppercase text-xs tracking-wider mb-2">The Outcome:</h4>
                  <p className="text-[#0D1B5C] font-semibold text-sm leading-relaxed">
            ...
            <div className="relative h-64 lg:h-auto bg-[#0D1B5C]">
      ...
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {services.map((service, idx) => (
            <div key={idx} className="bg-[#F8FAFC] p-8 rounded-xl border border-[#E2E8F0] hover:border-[#0D1B5C] transition-colors group">
              <h3 className="text-xl font-bold text-[#0D1B5C] mb-3">{service.title}</h3>
              <p className="text-[#64748B] text-sm leading-relaxed mb-6">
                {service.desc}
              </p>
              <Link href={service.href} className="inline-flex items-center text-[#E31B23] font-bold text-sm group-hover:underline">
...
function ResourcesSection() {
  return (
    <Section bg="white" id="resources">
      <Container>
        <div className="bg-[#0D1B5C] rounded-2xl p-8 md:p-12 text-white overflow-hidden relative">
