...
function HeroSection() {
  return (
    <div className="relative bg-white pt-4 pb-12 sm:pt-6 md:pt-6 md:pb-20 overflow-hidden border-b border-slate-200" id="hero">
      ...
      <Container className="relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          <div className="flex flex-col items-start z-10 pt-1 lg:pt-2">
            <Heading variant="section" as="h1" className="text-3xl sm:text-4xl lg:text-[2.75rem] xl:text-[3.25rem] font-bold text-honeywell-navy leading-[1.12] mb-5">
