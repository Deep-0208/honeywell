...
export default function CetopManifoldBlocksPage() {
  ...
  return (
    <>
      ...
      <SiteLocationsSection productName="CETOP Manifold Blocks" />
    ...
    <div className="relative bg-white pt-8 pb-16 md:pt-12 md:pb-24 overflow-hidden border-b border-slate-200" id="hero">
      ...
      <Container>
          ...
          <ol className="flex items-center gap-2 flex-wrap">
            ...
            <li aria-hidden="true">&rsaquo;</li>
            <li className="text-honeywell-red font-semibold" aria-current="page">Cetop Manifold Blocks</li>
          </ol>
        </nav>
    ...
    <Section bg="white" id="overview">
      <Container>
        <div className="max-w-4xl mx-auto">
          <Heading variant="section" as="h2" underline="center" className="text-center">
