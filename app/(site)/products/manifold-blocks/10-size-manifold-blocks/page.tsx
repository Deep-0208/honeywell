      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-5 text-brand-darkSlate text-lg leading-relaxed">
            ...
            <p className="font-bold text-honeywell-red text-justify">
  ...
  return (
    <Section bg="gray" id="performance">
      <Container>
        ...
        <div className="max-w-4xl mx-auto">
          <SpecTable rows={NG16_PERFORMANCE} />
        </div>
      </Container>
    </Section>
  );
      ...
      <Container>
        <div className="max-w-5xl mx-auto bg-brand-lightSurface rounded-2xl border border-slate-200 overflow-hidden shadow-sm flex flex-col md:flex-row">
          ...
          <div className="md:w-3/5 p-8 md:p-12">
            ...
            <p className="text-sm font-bold text-honeywell-red tracking-wide uppercase mb-6 text-justify">Material Handling Equipment Builder — Odhav GIDC, Ahmedabad</p>
