...
import { DC_MINI_FAQS, DC_MINI_SPECS, DC_MINI_INDUSTRIES } from '@/data/hydraulic-power-packs/dc-mini-power-packs';
import {
  ArrowRight,
  MessageCircle,
  ShieldAlert,
  ...
  return {
    ...
    '@graph': [
      ...
      /* 4. FAQPage */
      {
        ...
        mainEntity: DC_MINI_FAQS.map((faq) => ({
          '@type': 'Question',
          name: faq.question,
          acceptedAnswer: {
            '@type': 'Answer',
...
function VoltageComparisonSection() {
  return (
    <Section aria-labelledby="voltage-comparison-heading" bg="white" id="voltage-comparison">
      <Container>
...
function PhaseComparisonSection() {
  return (
    <Section aria-labelledby="phase-comparison-heading" bg="gray" id="phase-comparison">
      <Container>
        <div className="max-w-4xl mx-auto mb-12 text-center">
    ...
    <Section aria-labelledby="technical-specifications-heading" bg="white" id="technical-specifications">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          <SpecTable title="Standard Capabilities" rows={DC_MINI_SPECS} />
        </div>
      </Container>
    </Section>
  );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative aspect-square lg:aspect-[4/3] rounded-xl overflow-hidden shadow-lg border border-slate-200">
            ...
            <div className="absolute bottom-6 left-6 right-6">
              ...
              <Heading variant="subsection" as="h3" className="text-white text-xl font-bold">Electrical Load & Duty Cycle Validation</Heading>
            </div>
          </div>
        </div>
      </Container>
...
function RelatedProducts() {
  const products = [
    ...
    },
    {
      ...
      description: 'Continuous-duty fluid generation for factory automation.',
    ...
    },
    {
      ...
      description: 'Multi-stage extreme-stroke actuators for tipper trucks.',
  ...
  const services = [
    {
      ...
      description: 'High-volume, repeatable production of compact DC power units specifically for truck body builders and material handling OEMs.',
      link: '#',
      icon: <Settings className="w-6 h-6 text-honeywell-navy" />
    },
    {
      title: 'Hydraulic Consulting',
      description: 'Hire our systems architects to audit your vehicle\'s electrical harness and recommend the correct battery and wire gauges.',
      link: '#',
      icon: <MessageCircle className="w-6 h-6 text-honeywell-navy" />
    },
    {
      title: 'Custom Hydraulic System Design',
      description: 'We design complete mobile circuits, including specialized safety valves to prevent tail lift drops if a hose bursts on the highway.',
      link: '#',
